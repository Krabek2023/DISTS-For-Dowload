init:
    ...
    define Member = Character('Соучастник', color = "#ac2d06")
    ...
    define noname = Character('Неизвестый', color = "#ac0606")
    define boss = Character('Главарь', color = "#ff0000")
    define frend = Character('Друг', color = "#093b13")  
    define group = Character('Одногруппник', color = "#ac2d06")
    define club = Character('Глава клуба', color = "#ac2d06")
    define allies = Character('Остальные', color = '#b7d436')